...
class CreateLsalAuditLogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection(config('simple-audit-log.audit_log_db_connection'))->create('lsal_audit_logs', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('al_actor_id')->index('al_actor_id_index')->comment('User id in application. Can be null in cases where an action is performed programmatically.');
            ...
            $table->unsignedBigInteger('al_actor_global_uid')->nullable()->index('al_actor_global_uid_index')->comment('User id if using a single sign on facility.');
            ...
            $table->unsignedBigInteger('al_target_id')->nullable()->index('al_target_id_index')->comment('The ID of the resource that is being accessed.');
            ...
            $table->text('al_custom_field_1')->nullable();
            $table->text('al_custom_field_2')->nullable();
            $table->text('al_custom_field_3')->nullable();
